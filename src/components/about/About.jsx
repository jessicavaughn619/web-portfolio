  ...
  return (
    <div id="about">
      ...
      <div className="about__container">
        ...
        <p>I am a 10x Certified Salesforce Consultant & Developer with Hike2, where I design and build custom cloud-solutions for clients. Prior to joining Hike2, I worked as a full-stack web developer designing and building solutions for small businesses and non-profit organizations.</p>
